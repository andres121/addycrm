...
class ProjectController extends BaseController
{
     ...
     */
    public function store(ProjectRequest $request, BaseHttpResponse $response, SaveFacilitiesService $saveFacilitiesService)
    {
     ...
     * @return BaseHttpResponse
     */
    public function update(ProjectRequest $request, $id, BaseHttpResponse $response, SaveFacilitiesService $saveFacilitiesService)
    {
        $project = $this->projectRepository->findOrFail($id);
